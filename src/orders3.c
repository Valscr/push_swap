...
/*   Updated: 2022/10/05 20:47:16 by valentin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rrb(t_data *data, int write)
{
	...
	if (write == 1)
	{
		data->a[data->count] = malloc(sizeof(char) * 4);
		data->a[data->count][0] = 'r';
		data->a[data->count][1] = 'r';
		data->a[data->count][2] = 'b';
		data->a[data->count][3] = '\0';
	}
	data->count++;
	return ;
}
